...
rmt_obj_t* RMTClass::txInit(int pin, float tick, uint8_t blockNum)
{
...
void RMTClass::txDeinit(rmt_obj_t* ch)
{
    rmtDeinit(ch);
}
...
bool RMTClass::writeAsync(rmt_obj_t* ch, rmt_data_t* data, size_t size)
{

...
#define ESP_PANEL_LCD_H_RES         (240)//320
#define ESP_PANEL_LCD_V_RES         (320)//240
 ...
 */
    ...
    #define ESP_PANEL_LCD_SPI_IO_CS             (14)
    #define ESP_PANEL_LCD_SPI_IO_DC             (13)
    ...
    #define ESP_PANEL_LCD_SPI_IO_SCK            (12)
    #define ESP_PANEL_LCD_SPI_IO_MOSI           (21)
